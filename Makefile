...
build/main.exe: build/main.o build/Chessboard.o build/Move.o
	gcc -std=c99 -o build/main.exe build/main.o build/Chessboard.o build/Move.o -L libsdl/lib -l mingw32 -l SDL2main -l SDL2 -l SDL2_image
